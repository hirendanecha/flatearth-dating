...
export class CustomerService {
  ...
  startCallToBuzzRing(callerData: Object): Observable<any>{
    const url = 'https://ring-dev-api.flatearth.dating/api/customers/call-notification';
    return this.http.post(url, callerData);
  }
  
  startGroupCallToBuzzRing(callerData: Object): Observable<any>{
    const url = 'https://ring-api.flatearth.dating/api/v1/customers/group-call-notification';
    return this.http.post(url, callerData);
  }
